...
Inductive Tm (n_Tm : nat) : Type :=
  ...
  | ifzero : Tm n_Tm -> Tm (S n_Tm) -> Tm n_Tm -> Tm n_Tm
  | nrec : Tm (S n_Tm) -> Tm n_Tm -> Tm n_Tm -> Tm n_Tm
  | disp : nat -> Tm n_Tm -> Tm n_Tm
  | aabs : nat -> Tm (S n_Tm) -> Tm n_Tm.
...
Lemma congr_ifzero {m_Tm : nat} {s0 : Tm m_Tm} {s1 : Tm (S m_Tm)}
  {s2 : Tm m_Tm} {t0 : Tm m_Tm} {t1 : Tm (S m_Tm)} {t2 : Tm m_Tm}
  (H0 : s0 = t0) (H1 : s1 = t1) (H2 : s2 = t2) :
  ifzero m_Tm s0 s1 s2 = ifzero m_Tm t0 t1 t2.
Proof.
exact (eq_trans
         (eq_trans (eq_trans eq_refl (ap (fun x => ifzero m_Tm x s1 s2) H0))
            (ap (fun x => ifzero m_Tm t0 x s2) H1))
         (ap (fun x => ifzero m_Tm t0 t1 x) H2)).
Qed.
...
Lemma congr_disp {m_Tm : nat} {s0 : nat} {s1 : Tm m_Tm} {t0 : nat}
  {t1 : Tm m_Tm} (H0 : s0 = t0) (H1 : s1 = t1) :
  disp m_Tm s0 s1 = disp m_Tm t0 t1.
Proof.
exact (eq_trans (eq_trans eq_refl (ap (fun x => disp m_Tm x s1) H0))
         (ap (fun x => disp m_Tm t0 x) H1)).
Qed.

Lemma congr_aabs {m_Tm : nat} {s0 : nat} {s1 : Tm (S m_Tm)} {t0 : nat}
  {t1 : Tm (S m_Tm)} (H0 : s0 = t0) (H1 : s1 = t1) :
  aabs m_Tm s0 s1 = aabs m_Tm t0 t1.
Proof.
exact (eq_trans (eq_trans eq_refl (ap (fun x => aabs m_Tm x s1) H0))
         (ap (fun x => aabs m_Tm t0 x) H1)).
Qed.
...
(s : Tm m_Tm) {struct s} : Tm n_Tm :=
  ...
  | ifzero _ s0 s1 s2 =>
      ifzero n_Tm (ren_Tm xi_Tm s0) (ren_Tm (upRen_Tm_Tm xi_Tm) s1)
        (ren_Tm xi_Tm s2)
  | nrec _ s0 s1 s2 =>
      nrec n_Tm (ren_Tm (upRen_Tm_Tm xi_Tm) s0) (ren_Tm xi_Tm s1)
        (ren_Tm xi_Tm s2)
  | disp _ s0 s1 => disp n_Tm s0 (ren_Tm xi_Tm s1)
  | aabs _ s0 s1 => aabs n_Tm s0 (ren_Tm (upRen_Tm_Tm xi_Tm) s1)
  end.
...
(s : Tm m_Tm) {struct s} : Tm n_Tm :=
  ...
  | ifzero _ s0 s1 s2 =>
      ifzero n_Tm (subst_Tm sigma_Tm s0) (subst_Tm (up_Tm_Tm sigma_Tm) s1)
        (subst_Tm sigma_Tm s2)
  | nrec _ s0 s1 s2 =>
      nrec n_Tm (subst_Tm (up_Tm_Tm sigma_Tm) s0) (subst_Tm sigma_Tm s1)
        (subst_Tm sigma_Tm s2)
  | disp _ s0 s1 => disp n_Tm s0 (subst_Tm sigma_Tm s1)
  | aabs _ s0 s1 => aabs n_Tm s0 (subst_Tm (up_Tm_Tm sigma_Tm) s1)
  end.
...
subst_Tm sigma_Tm s = s :=
  ...
  | ifzero _ s0 s1 s2 =>
      congr_ifzero (idSubst_Tm sigma_Tm Eq_Tm s0)
  ...
  | disp _ s0 s1 => congr_disp (eq_refl s0) (idSubst_Tm sigma_Tm Eq_Tm s1)
  | aabs _ s0 s1 =>
      congr_aabs (eq_refl s0)
        (idSubst_Tm (up_Tm_Tm sigma_Tm) (upId_Tm_Tm _ Eq_Tm) s1)
  end.
...
(s : Tm m_Tm) {struct s} : ren_Tm xi_Tm s = ren_Tm zeta_Tm s :=
  ...
  | ifzero _ s0 s1 s2 =>
      congr_ifzero (extRen_Tm xi_Tm zeta_Tm Eq_Tm s0)
        (extRen_Tm (upRen_Tm_Tm xi_Tm) (upRen_Tm_Tm zeta_Tm)
  ...
  | disp _ s0 s1 =>
      congr_disp (eq_refl s0) (extRen_Tm xi_Tm zeta_Tm Eq_Tm s1)
  | aabs _ s0 s1 =>
      congr_aabs (eq_refl s0)
        (extRen_Tm (upRen_Tm_Tm xi_Tm) (upRen_Tm_Tm zeta_Tm)
           (upExtRen_Tm_Tm _ _ Eq_Tm) s1)
...
(s : Tm m_Tm) {struct s} : subst_Tm sigma_Tm s = subst_Tm tau_Tm s :=
  ...
  | ifzero _ s0 s1 s2 =>
      congr_ifzero (ext_Tm sigma_Tm tau_Tm Eq_Tm s0)
        (ext_Tm (up_Tm_Tm sigma_Tm) (up_Tm_Tm tau_Tm) (upExt_Tm_Tm _ _ Eq_Tm)
           s1)
  ...
  | disp _ s0 s1 => congr_disp (eq_refl s0) (ext_Tm sigma_Tm tau_Tm Eq_Tm s1)
  | aabs _ s0 s1 =>
      congr_aabs (eq_refl s0)
        (ext_Tm (up_Tm_Tm sigma_Tm) (up_Tm_Tm tau_Tm) (upExt_Tm_Tm _ _ Eq_Tm)
           s1)
...
ren_Tm zeta_Tm (ren_Tm xi_Tm s) = ren_Tm rho_Tm s :=
  ...
  | ifzero _ s0 s1 s2 =>
      congr_ifzero (compRenRen_Tm xi_Tm zeta_Tm rho_Tm Eq_Tm s0)
        (compRenRen_Tm (upRen_Tm_Tm xi_Tm) (upRen_Tm_Tm zeta_Tm)
  ...
  | nrec _ s0 s1 s2 =>
      congr_nrec
        ...
        (compRenRen_Tm xi_Tm zeta_Tm rho_Tm Eq_Tm s2)
  | disp _ s0 s1 =>
      congr_disp (eq_refl s0) (compRenRen_Tm xi_Tm zeta_Tm rho_Tm Eq_Tm s1)
  | aabs _ s0 s1 =>
      congr_aabs (eq_refl s0)
        (compRenRen_Tm (upRen_Tm_Tm xi_Tm) (upRen_Tm_Tm zeta_Tm)
           (upRen_Tm_Tm rho_Tm) (up_ren_ren _ _ _ Eq_Tm) s1)
...
subst_Tm tau_Tm (ren_Tm xi_Tm s) = subst_Tm theta_Tm s :=
  ...
  | ifzero _ s0 s1 s2 =>
      congr_ifzero (compRenSubst_Tm xi_Tm tau_Tm theta_Tm Eq_Tm s0)
        (compRenSubst_Tm (upRen_Tm_Tm xi_Tm) (up_Tm_Tm tau_Tm)
...
ren_Tm zeta_Tm (subst_Tm sigma_Tm s) = subst_Tm theta_Tm s :=
  ...
  | ifzero _ s0 s1 s2 =>
      congr_ifzero (compSubstRen_Tm sigma_Tm zeta_Tm theta_Tm Eq_Tm s0)
        (compSubstRen_Tm (up_Tm_Tm sigma_Tm) (upRen_Tm_Tm zeta_Tm)
...
subst_Tm tau_Tm (subst_Tm sigma_Tm s) = subst_Tm theta_Tm s :=
  ...
  | ifzero _ s0 s1 s2 =>
      congr_ifzero (compSubstSubst_Tm sigma_Tm tau_Tm theta_Tm Eq_Tm s0)
        (compSubstSubst_Tm (up_Tm_Tm sigma_Tm) (up_Tm_Tm tau_Tm)
...
{struct s} : ren_Tm xi_Tm s = subst_Tm sigma_Tm s :=
  ...
  | ifzero _ s0 s1 s2 =>
      congr_ifzero (rinst_inst_Tm xi_Tm sigma_Tm Eq_Tm s0)
        (rinst_inst_Tm (upRen_Tm_Tm xi_Tm) (up_Tm_Tm sigma_Tm)
  ...
  | nrec _ s0 s1 s2 =>
      congr_nrec
        ...
        (rinst_inst_Tm xi_Tm sigma_Tm Eq_Tm s2)
  | disp _ s0 s1 =>
      congr_disp (eq_refl s0) (rinst_inst_Tm xi_Tm sigma_Tm Eq_Tm s1)
  | aabs _ s0 s1 =>
      congr_aabs (eq_refl s0)
        (rinst_inst_Tm (upRen_Tm_Tm xi_Tm) (up_Tm_Tm sigma_Tm)
           (rinstInst_up_Tm_Tm _ _ Eq_Tm) s1)
...
Lemma rinstInst_Tm {m_Tm : nat} {n_Tm : nat} (xi_Tm : fin m_Tm -> fin n_Tm) :
  ren_Tm xi_Tm = subst_Tm (funcomp (var n_Tm) xi_Tm).
Proof.
exact (FunctionalExtensionality.functional_extensionality _ _
         (fun x => rinst_inst_Tm xi_Tm _ (fun n => eq_refl) x)).
Qed.

Lemma instId_Tm {m_Tm : nat} : subst_Tm (var m_Tm) = id.
Proof.
exact (FunctionalExtensionality.functional_extensionality _ _
         (fun x => idSubst_Tm (var m_Tm) (fun n => eq_refl) (id x))).
Qed.
...
Lemma varL_Tm {m_Tm : nat} {n_Tm : nat} (sigma_Tm : fin m_Tm -> Tm n_Tm) :
  funcomp (subst_Tm sigma_Tm) (var m_Tm) = sigma_Tm.
Proof.
exact (FunctionalExtensionality.functional_extensionality _ _
         (fun x => eq_refl)).
Qed.
...
Lemma varLRen_Tm {m_Tm : nat} {n_Tm : nat} (xi_Tm : fin m_Tm -> fin n_Tm) :
  funcomp (ren_Tm xi_Tm) (var m_Tm) = funcomp (var n_Tm) xi_Tm.
Proof.
exact (FunctionalExtensionality.functional_extensionality _ _
         (fun x => eq_refl)).
Qed.
...
Ltac asimpl_fext := check_no_evars; repeat try unfold_funcomp;
                     repeat
                      unfold VarInstance_Tm, Var, ids, Ren_Tm, Ren1, ren1,
                       Up_Tm_Tm, Up_Tm, up_Tm, Subst_Tm, Subst1, subst1 
                       in *;
                     asimpl_fext'; repeat try unfold_funcomp.
